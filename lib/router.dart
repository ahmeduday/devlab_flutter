      ...
      YaruLayout(
        child: Consumer(
          builder: (context, ref, _) {
            ...
            return Scaffold(
              appBar:
                  DefaultAppBar(title: selectedTool.name != "home" ? selectedTool.fullTitle : (selectedGroup ?? home.fullTitle)),
    ...
    for (final tool in allTools)
      GoRoute(
        ...
        pageBuilder: (BuildContext context, GoRouterState state) =>
            _buildPageWithDefaultTransition(context: context, state: state, child: tool.page),
      )
