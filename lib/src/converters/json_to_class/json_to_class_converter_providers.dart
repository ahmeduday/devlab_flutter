import 'package:devlab_flutter/src/converters/json_to_class/json_to_class_converter.dart';
...
final outputTextProvider = StateProvider<String>((ref) {
  ...
  String result = convertJsonToClass(inputText, className: ref.watch(classNameProvider), language: ProgrammingLanguage.dart);
