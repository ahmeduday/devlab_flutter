...
import 'package:devlab_flutter/src/converters/json_yaml/json_yaml_converter.dart';
...
final outputTextProvider = StateProvider((ref) {
  ...
  if (conversionType == JsonYamlConversionType.jsonToYaml) {
    result = convertJsonToYaml(text, yamlStyle: yamlStyle, sortAlphabetically: sortAlphabetically);
  } else {
    result = convertYamlToJson(text, sortAlphabetically: sortAlphabetically, indentation: ref.watch(indentationProvider));
  }
