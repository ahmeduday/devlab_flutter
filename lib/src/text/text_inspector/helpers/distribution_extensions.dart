...
import 'package:devlab_flutter/src/text/text_inspector/helpers/split_extension.dart';
...
extension DistributionMapExtensions on DistributionMap {
  String getString() {
    ...
    final sortedMap = Map.fromEntries(entries.toList()..sort((e1, e2) => e2.value.compareTo(e1.value)));
