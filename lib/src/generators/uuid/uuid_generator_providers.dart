import 'package:devlab_flutter/src/generators/uuid/uuid_generator.dart';
...
final uuidGeneratorProvider = NotifierProvider<UuidGenerator, String>(UuidGenerator.new);
